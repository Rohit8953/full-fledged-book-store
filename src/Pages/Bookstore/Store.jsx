...
import { addproductDetails, Setaddtocart, Setlikecart } from "../../Redux/productSlice";
...
const onclickOnProduct=(product)=>{
  ...
  return (
    <div>
      ...
      <div className="mt-6 mb-3 mx-auto text-gray-600 w-fit flex flex-row justify-between items-center  border-2 border-gray-300 bg-white h-10 px-5 rounded-lg text-sm ">
        ...
        <div className="flex flex-col sm:flex-row w-full gap-6">
            ...
            <div className="">
                ...
                <div className="flex items-center gap-3">
                    ...
                    value={"dsc"}
                    />
                    <label className="  whitespace-nowrap  min-w-0 flex-1 text-gray-500">High to Low</label>
                </div>
                </form>
            </div>
           ...
           <div class="border-t border-gray-200 px-4 py-6">
                <h3 class="-mx-2 -my-3 flow-root">
                    ...
                    >
                    <span class="text-base uppercase font-medium text-slate-500 ">Categrory</span>
                ...
                >
                    ...
                    {data.map((data, index) => {
                        return (
                        <div key={index} onChange={(e) => onChecked(data.id, e.target.value, e.target.checked)} className="flex items-center">
                            <input
            ...
            <div className="mt-6  grid grid-cols-1 mx-auto items-center justify-center  gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                ...
                <div key={product.id} className="group relative bg-gray-50  max-w-xs mx-auto shadow-md rounded-md">
                    <div onClick={()=>onclickOnProduct(product)} className="aspect-h-1 aspect-w-1 w-full overflow-hidden lg:aspect-none group-hover:opacity-75 lg:h-80">
                    <img
                        alt={product.image}
                        src={product.image}
                 ...
                 <div className=" flex flex-col justify-between p-2">
                    <div onClick={()=>onclickOnProduct(product)} className="mt-4 p-2">
                    ...
                    <div className="flex flex-row justify-between items-center mb-4 ">
                        ...
                        <button onClick={()=>dispatch(Setaddtocart(product))} className="text-sm bg-blue-400 hover:bg-blue-600 text-white px-3 py-0.5 rounded-full">
                          Add-to Cart
                        </button> 
                        
                        <button onClick={()=>dispatch(Setlikecart(product))} className="text-sm bg-blue-400 hover:bg-blue-600 text-white px-3 py-0.5 rounded-full">
                          WishList
                        </button>
