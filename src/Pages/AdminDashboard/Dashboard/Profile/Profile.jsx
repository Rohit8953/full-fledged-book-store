    ...
    <div>
      <section class="w-full overflow-hidden dark:bg-gray-900">
        <div class="flex flex-col">
            ...
            <div class="sm:w-[80%] w-[90%] mx-auto flex gap-5 ">
                <img src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw3fHxwZW9wbGV8ZW58MHwwfHx8MTcxMTExMTM4N3ww&ixlib=rb-4.0.3&q=80&w=1080" alt="User Profile"
                    class="rounded-md lg:w-[12rem] lg:h-[12rem] md:w-[10rem] md:h-[10rem] w-[8rem] h-[8rem]  outline outline-2 outline-offset-2 outline-blue-500 relative lg:bottom-[5rem] sm:bottom-[4rem] bottom-[3rem]" 
                />
            ...
            <div
                class="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] p-5 mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
                        ...
                        <div class="w-full">
                            <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                <div class="flex flex-col pb-3">
                                    ...
                                    <dd class="text-lg font-semibold">Jhansi, Uttar pradesh</dd>
                                </div>
                                ...
                                <div class="flex flex-col pt-3">
                                    ...
                                    <dd class="text-lg font-semibold">rc3881425@gmail.com</dd>
                                </div>

                                <div class="flex flex-col pt-3">
                                    <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Website</dt>
                                    <dd class="text-lg font-semibold">https://www.example.com</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                ...
                <div class="my-10 lg:w-[70%] md:h-[14rem] xs:w-full xs:h-[10rem]">
                        ...
                        <iframe
                            src="https://goo.gl/maps/exBmf9X2V2RCa3wC9"
