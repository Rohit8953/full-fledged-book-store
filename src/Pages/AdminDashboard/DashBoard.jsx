...
const DashBoard = () => {
  ...
  return (
    <div className='bg-lightPrimary flex flex-col md:flex-row mt-20'>

       {/* Left section Sidebar------->>>>>>>>>>>>>>>> */}
      <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-full md:min-h-screen max-w-full md:max-w-[20rem] p-4 shadow-md shadow-blue-gray-900/5">
        <div class="mb-2 p-4">
        ...
        <nav class="flex flex-col gap-1  min-w-[240px]  p-2 font-sans text-base font-normal text-gray-700">
          ...
          <Link to='/dashboard/paymentmanage' role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
            <div class="grid place-items-center mr-4">
            <MdOutlineManageAccounts />
            </div>Payment history
          </Link>
